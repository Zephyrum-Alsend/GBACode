...
inline uint16 MakeCol(uint8 red, uint8 green, uint8 blue); // RGB values range from 0 - 31
inline void vsync();
...
int main()
{
    ...
    {
    	vsync();
    	drawRect(x % SCREEN_W, (x / SCREEN_W) * 12, 12, 12, MakeCol(31,0,0));
    	x += 25;
    }
